...
(float)graphics.GraphicsDevice.Viewport.Width /
        ...
        {
            //timeDelta = tiden mellom to kall p� Update
            float timeDelta = (float)gameTime.ElapsedGameTime.TotalSeconds;

            //Ved kort tid mellom hver frame vil timeDelta v�re liten og 
            ...
            // Beregner hva kameraet ser p� (cameraTarget) vha. 
            // n�v�rende posisjonsvektor og retningsvektoren:
            ...
            //Oppdaterer view-matrisa vha. posisjons, kameram�l og opp-vektorene:
